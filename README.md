...
This is a **competition-facing public repository** prepared for the President Tech Award Incubation Program.

It contains or will contain a curated subset of Ready4Trade code and sample data sufficient to demonstrate the technical MVP.

For security, privacy, and intellectual-property reasons, the public repository does **not** include:
...
- private user logs;
- personal data;
- confidential exporter information;
- production database credentials;
- complete proprietary/commercial datasets;
...
Use an `.env.example` file with placeholders, for example:
...
The real `.env` file must remain excluded by `.gitignore`.
